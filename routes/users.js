...
router.post('/register', function(req, res){
	...
	req.checkBody('password2', 'Пароль должен совпадать').equals(req.body.password);
...
router.post('/login',
  passport.authenticate('local', {successRedirect:'/', failureRedirect:'/users/login',failureFlash: 'Неправильное имя или пароль'}),
  function(req, res) {
    res.redirect('/');
  });
